...
/**
 * Clase propia que representa la forma de dibujo Elipse.
 ...
 */
public class MyShapeElipse extends MyPaintConRelleno{
    
    /**
     * Constructor de la clase MyShapeElipse que inicializa el objeto de tipo formaDibujo 
     * de la superclase MyShape como Ellipse2D.
     ...
     */
    public MyShapeElipse(Point2D p1, Color cTrazo, boolean tPunteado,
        ...
        this.formaDibujo = new Ellipse2D.Double(p1.getX(), p1.getY(), 0.0D, 0.0D);
    ...
    /**
     * Método que se encarga de modificar la diagonal de una figura, en este caso de Ellipse2D.
    ...
    public void setCoordenadas(Point2D p1, Point2D p2) {
        this.pEdit1 = p1;
        this.pEdit2 = p2;
        ((Ellipse2D)this.formaDibujo).setFrameFromDiagonal(p1, p2);
    }
    
    /**
     * Método que se encarga de modificar la posición de una figura, en este caso de Ellipse2D.
    ...
    public void setLocation(Point2D p1, Point2D p2) {
        ...
        ((Ellipse2D)this.formaDibujo).setFrameFromDiagonal(x1, y1, x2, y2);
    }
}
